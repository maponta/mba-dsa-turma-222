...
for (i in 1:nrow(combinacoes)) {
  ...
  fileWordcloudPositve <- paste0("Output/normal_sentiment_sentilex_lem/", output, "-postive-wordcloud.png")
  fileWordcloudNeutral <- paste0("Output/normal_sentiment_sentilex_lem/", output, "-neutral-wordcloud.png")
  fileWordcloudNegative <- paste0("Output/normal_sentiment_sentilex_lem/", output, "-negative-wordcloud.png")
