...
for (i in 1:nrow(combinacoes)) {
  ...
  fileBow <- paste0("Output/lem_bow_n1_itau_at_07082023/", output, "-bow-n1-lem-wordcloud.png")
  fileBar <- paste0("Output/lem_bow_n1_itau_at_07082023/", output, "-bow-n1-lem-bar.png")
