...
for (i in 1:nrow(combinacoes)) {
  ...
  fileBow <- paste0("Output/lem_bow_n2_itau_at_07082023/", output, "-bow-n2-lem-wordcloud.png")
  fileBar <- paste0("Output/lem_bow_n2_itau_at_07082023/", output, "-bow-n2-lem-bar.png")
