...
for (i in 1:nrow(combinacoes)) {
  ...
  fileBow <- paste0("Output/lem_bow_n2_itau_not_07082023/", output, "-bow-n2-lem-wordcloud.png")
  fileBar <- paste0("Output/lem_bow_n2_itau_not_07082023/", output, "-bow-n2-lem-bar.png")
  ...
  graph <- ggplot(graph_data, aes(x = n, y = forcats::fct_rev(forcats::fct_infreq(word)))) +
    ...
    labs(title = "Bag of words n2 lem", x = "Frequência", y = "Palavra")
