...
for (i in 1:nrow(combinacoes)) {
  ...
  fileBow <- paste0("Output/normal_bow_n3_not_itau_07082023/", output, "-bow-n3-wordcloud.png")
  fileBar <- paste0("Output/normal_bow_n3_not_itau_07082023/", output, "-bow-n3-bar.png")
  ...
  graph <- ggplot(graph_data, aes(x = n, y = forcats::fct_rev(forcats::fct_infreq(word)))) +
    ...
    labs(title = "Bag of words n3 not itau 07/08/2023", x = "Frequência", y = "Palavra")
